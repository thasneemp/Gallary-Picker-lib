package test.launcher.mummu.gallerypicker.activity;
...
import test.launcher.mummu.gallerypicker.adapter.FolderPickerAdapter;
import test.launcher.mummu.gallerypicker.adapter.ImagePickerAdapter;
import test.launcher.mummu.gallerypicker.helper.Constants;
import test.launcher.mummu.gallerypicker.helper.ImageUtils;
import test.launcher.mummu.gallerypicker.listeners.OnFolderClickListener;
import test.launcher.mummu.gallerypicker.model.Folder;
import test.launcher.mummu.gallerypicker.model.Image;
...
public class ImagePickerActivity extends AppCompatActivity implements ImagePickerAdapter.ViewHolder.OnItemClickListener {
    ...
    private ArrayList<Image> tempSelectedImages;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mode == ImagePickerActivity.MODE_MULTIPLE && intent.hasExtra(ImagePickerActivity.INTENT_EXTRA_SELECTED_IMAGES)) {
            ...
            tempSelectedImages = new ArrayList<>();
            tempSelectedImages.addAll(selectedImages);
        }
